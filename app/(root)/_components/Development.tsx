...
import { application1, application2 } from "@/constants/application";
  ...
  return (
    <section className="max-w-6xl mx-auto px-4 py-4 lg:py-20">
      <div className="max-w-[270px] lg:max-w-[800px]">
        <SectionHeader title="Development of mobile applications" />
      </div>
